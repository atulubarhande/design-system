...
class AdvancedSearch::Component < ApplicationViewComponent
    include Turbo::FramesHelper
    include ApplicationHelper
    attr_reader :current_user
    option :current_user, default: proc { nil }
    option :view_for, default: proc { "" }
    option :search_url
    option :reset_url, default: proc { nil }
    option :ui_template, default: proc { "" }
    option :aditional_params, default: proc { {} }
    option :basic_search_hint, default: proc { I18n.t("devices.basic_search_hint") }
    option :search_form_data, default: proc { {} }
    ...
    def custom_data
      @search_form_data.merge({ devices_target: "form",
                    devices_filters_target: "form",
                    turbo_stream: "" })
    end
  end
